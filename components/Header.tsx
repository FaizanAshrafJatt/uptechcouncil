        ...
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              <Link
                href="/membership"
                className="relative inline-flex items-center justify-center gap-2 px-6 py-2.5 text-sm font-medium text-white rounded-lg overflow-hidden group transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:ring-offset-2 focus:ring-offset-[#050B14]"
                style={{
          ...
          <>
            ...
            <div className="p-6">
              ...
              <div className="mt-8 pt-6 border-t border-[rgba(234,242,255,0.1)] space-y-3">
                ...
                <Link
                  href="/membership"
                  className="block w-full text-center py-3 px-6 text-sm font-medium text-white rounded-lg transition-all duration-300 relative overflow-hidden group"
                  style={{
                    background: "linear-gradient(135deg, #1E40AF 0%, #1E3A8A 50%, #1E3A8A 100%)",
